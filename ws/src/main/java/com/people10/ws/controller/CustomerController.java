...
public class CustomerController {
    ...
    public ResponseEntity<String> addCustomer(@ApiParam(value = "Customer JSON to Save", required = true) @RequestBody Customer customer) {
        return customerService.saveCustomer(customer);
    }
    @PutMapping("/")
    @ApiOperation(value="update a customer", notes = "${CustomerController.updateCustomer.notes}")
    public ResponseEntity<String> updateCustomer(@ApiParam(value = "Customer JSON to Update", required = true) @RequestBody Customer customer) {
        return customerService.updateCustomer(customer);
    }
    @DeleteMapping("/{id}")
    @ApiOperation(value="delete a customer", notes = "${CustomerController.deleteCustomer.notes}")
    public ResponseEntity<String> deleteCustomer(@ApiParam(value = "Customer ID to Update", required = true) @PathVariable Long id) {
